...
const ApplicationList = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(`/api/applications/department/${deptId}`, {
    ...
    const handleApprove = (appId) => {
        axios
            ...
            .catch((err) => {
                setHasError(true);
                setErrorMsg(err.response?.data?.message || "Error approving application.");
            });
    };
    ...
    const handleReject = (appId) => {
        axios
            ...
            .catch((err) => {
                setHasError(true);
                setErrorMsg(err.response?.data?.message || "Error rejecting application.");
            });
    };
    ...
    return (
        <div className="container-fluid pt-5">
            ...
            {completed && <Redirect to="/application-list" />}
        </div>
    );
};
